...
func TestListDefinition(t *testing.T) {
	tests := []struct {
		...
		{name: "Empty list item", input: `- `, expect: []entity.LineElement{{
			Type:    entity.ElementKindList,
			Content: `- `,
		}}},
		{name: "List item with leading spaces", input: `-   Item with leading spaces`, expect: []entity.LineElement{{
			Type:    entity.ElementKindList,
			Content: `-   Item with leading spaces`,
		}}},
		{name: "List item with trailing spaces", input: `- Item with trailing spaces  `, expect: []entity.LineElement{{
			Type:    entity.ElementKindList,
			Content: `- Item with trailing spaces  `,
		}}},
		{name: "List item with leading and trailing spaces", input: `-   Item with leading and trailing spaces  `, expect: []entity.LineElement{{
			Type:    entity.ElementKindList,
			Content: `-   Item with leading and trailing spaces  `,
		}}},
		{name: "List item with nested list", input: `- Item with nested list
1. Sublist item`, expect: []entity.LineElement{{
			Type: entity.ElementKindList,
			Content: `- Item with nested list
1. Sublist item`,
		}}},
		{name: "List item with inline code", input: `- Item with ` + "`inline code`", expect: []entity.LineElement{{
			Type:    entity.ElementKindList,
			Content: `- Item with ` + "`inline code`",
		}}},
		{name: "List item with bold text", input: `- Item with **bold text**`, expect: []entity.LineElement{{
			Type:    entity.ElementKindList,
			Content: `- Item with **bold text**`,
		}}},
		{name: "List item with italic text", input: `- Item with *italic text*`, expect: []entity.LineElement{{
			Type:    entity.ElementKindList,
			Content: `- Item with *italic text*`,
		}}},
		{name: "List item with link", input: `- Item with [link](#)`, expect: []entity.LineElement{{
			Type:    entity.ElementKindList,
			Content: `- Item with [link](#)`,
		}}},
		{name: "List item with image", input: `- Item with ![image](url)`, expect: []entity.LineElement{{
			Type:    entity.ElementKindList,
			Content: `- Item with ![image](url)`,
		}}},
		{name: "List item with strikethrough text", input: `- Item with ~~strikethrough text~~`, expect: []entity.LineElement{{
			Type:    entity.ElementKindList,
			Content: `- Item with ~~strikethrough text~~`,
		}}},
		{name: "List item with task list", input: `- Item with task list
- [ ] Task 1
- [x] Task 2`, expect: []entity.LineElement{{
			Type: entity.ElementKindList,
			Content: `- Item with task list
- [ ] Task 1
- [x] Task 2`,
		}}},
		{name: "List item with quote", input: `- Item with > quote`, expect: []entity.LineElement{{
			Type:    entity.ElementKindList,
			Content: `- Item with > quote`,
		}}},
		{name: "List item with horizontal rule", input: `- Item with ---`, expect: []entity.LineElement{{
			Type:    entity.ElementKindList,
			Content: `- Item with ---`,
		}}},
		{name: "List item with a footnote", input: `- Item with a footnote[^1]`, expect: []entity.LineElement{{
			Type:    entity.ElementKindList,
			Content: `- Item with a footnote[^1]`,
		}}},
		{name: "List item with a heading ID", input: `- Item with a heading ID {#custom-id}`, expect: []entity.LineElement{{
			Type:    entity.ElementKindList,
			Content: `- Item with a heading ID {#custom-id}`,
		}}},
		{name: "List item with a strikethrough", input: `- Item with a strikethrough ~~strikethrough text~~`, expect: []entity.LineElement{{
			Type:    entity.ElementKindList,
			Content: `- Item with a strikethrough ~~strikethrough text~~`,
		}}},
		{name: "List item with a task list", input: `- Item with a task list
- [x] Task 1
- [ ] Task 2`, expect: []entity.LineElement{{
			Type: entity.ElementKindList,
			Content: `- Item with a task list
- [x] Task 1
- [ ] Task 2`,
		}}},
		{name: "List item with an emoji", input: `- Item with an emoji :joy:`, expect: []entity.LineElement{{
			Type:    entity.ElementKindList,
			Content: `- Item with an emoji :joy:`,
		}}},
		{name: "List item with a highlight", input: `- Item with a highlight ==very important words==`, expect: []entity.LineElement{{
			Type:    entity.ElementKindList,
			Content: `- Item with a highlight ==very important words==`,
		}}},
		{name: "List item with a subscript", input: `- Item with a subscript H~2~O`, expect: []entity.LineElement{{
			Type:    entity.ElementKindList,
			Content: `- Item with a subscript H~2~O`,
		}}},
		{name: "List item with a superscript", input: `- Item with a superscript X^2^`, expect: []entity.LineElement{{
			Type:    entity.ElementKindList,
			Content: `- Item with a superscript X^2^`,
		}}},
		{name: "List item with a non-breaking space character after it", input: `* &nbsp;
* List item`, expect: []entity.LineElement{{
			Type: entity.ElementKindList,
			Content: `* &nbsp;
* List item`,
		}}},
...
2. Two
2.1 Two dot one
3. Three`, expect: []entity.LineElement{{
			Type: entity.ElementKindList,
			Content: `1. One
2. Two
2.1 Two dot one
...
- Two
- Two dot one
- Three`, expect: []entity.LineElement{{
			Type: entity.ElementKindList,
			Content: `- One
- Two
- Two dot one
...
- Two
	- Two dot one
- Three
	- Three dot one`, expect: []entity.LineElement{{
			Type: entity.ElementKindList,
			Content: `- One
	- One dot one
- Two
...
Another line with text...`, expect: []entity.LineElement{{
...
* List item 2
	* Sublist item 2.1
	* Sublist item 2.2
* List item 3`, expect: []entity.LineElement{{
			Type: entity.ElementKindList,
...
+ list item 2`, expect: []entity.LineElement{{
			Type:    entity.ElementKindList,
			Content: `+ list item 1`,
...
- Two
	- Two dot one
- Three`}, {Type: entity.ElementKindText,
			Content: `
Another line with text...`,
		}}},
		{name: "List item with punctuation after items", input: `- One.
...
+ list item 2`, expect: []entity.LineElement{{
			...
			Content: `+ list item 1`},
			{Type: entity.ElementKindText, Content: ``},
			{Type: entity.ElementKindList, Content: `+ list item 2`}}},
...
+ Item 2
* Item 3`, expect: []entity.LineElement{{
			Type: entity.ElementKindList,
			Content: `- Item 1
+ Item 2
* Item 3`,
...
+ Item 1.1
	* Item 1.1.1`, expect: []entity.LineElement{{
			Type: entity.ElementKindList,
			Content: `- Item 1
+ Item 1.1
	* Item 1.1.1`,
...
+ Item 1.1
	* Item 1.1.1
	+ Item 1.1.2
	- Item 1.1.2.1`, expect: []entity.LineElement{{
			Type: entity.ElementKindList,
			Content: `- Item 1
+ Item 1.1
	* Item 1.1.1
...
Some text after the list.`, expect: []entity.LineElement{{
			Type:    entity.ElementKindList,
			Content: `- List item`,
		}, {
			Type:    entity.ElementKindText,
...
# Heading`, expect: []entity.LineElement{{
			Type:    entity.ElementKindList,
			Content: `- List item`,
		}, {
			Type: entity.ElementKindText,
...
# Heading`, expect: []entity.LineElement{{
			Type:    entity.ElementKindList,
			Content: `- List item`,
		}, {Type: entity.ElementKindText, Content: `Some text after the list.
This is a paragraph after the list.
# Heading`}}},
...
> This is a blockquote before the list.`,
			...
			{Type: entity.ElementKindList, Content: `- List item`},
			{Type: entity.ElementKindText,
				Content: `Some text after the list.
This is a paragraph after the list.
> This is a blockquote after the list.
# Heading`}}},
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			got := parseLineListElement([]entity.LineElement{{Type: "text", Content: test.input}})
