...
func TestParseLineImageElement(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			input: "![](image.jpg)",
			expect: []entity.LineElement{
				{Type: entity.ElementKindImage, Content: "![](image.jpg)"},
			},
		},
		{
		...
		},
		{
			...
			expect: []entity.LineElement{
				{Type: entity.ElementKindImage, Content: "![relative path](./images/image.jpg)"},
			},
		},
		{
			...
			expect: []entity.LineElement{
				{Type: entity.ElementKindImage, Content: "![absolute path](/images/image.jpg)"},
			},
		},
		{
			...
			expect: []entity.LineElement{
				{Type: entity.ElementKindImage, Content: "![protocol](http://example.com/images/image.jpg)"},
			},
		},
		{
			...
			expect: []entity.LineElement{
				{Type: entity.ElementKindImage, Content: "![protocol](https://example.com/images/image.jpg)"},
			},
		},
		{
			...
			expect: []entity.LineElement{
				{Type: entity.ElementKindImage, Content: "![protocol](ftp://example.com/images/image.jpg)"},
			},
		},
		{
			...
			expect: []entity.LineElement{
				{Type: entity.ElementKindImage, Content: "![protocol](sftp://example.com/images/image.jpg)"},
			},
		},
		{
			...
			expect: []entity.LineElement{
				{Type: entity.ElementKindImage, Content: "![protocol](ssh://example.com/images/image.jpg)"},
			},
		},
		{
			...
			expect: []entity.LineElement{
				{Type: entity.ElementKindImage, Content: "![protocol](file:///home/user/images/image.jpg)"},
			},
		},
		{
			...
			expect: []entity.LineElement{
				{Type: entity.ElementKindImage, Content: "![protocol](mailto:user@example.com)"},
			},
		},
		{
			...
			expect: []entity.LineElement{
				{Type: entity.ElementKindImage, Content: "![protocol](tel:+1234567890)"},
			},
		},
		{
			...
			expect: []entity.LineElement{
				{Type: entity.ElementKindImage, Content: "![invalid protocol](invalid://example.com/images/image.jpg)"},
			},
		},
		{
			...
			expect: []entity.LineElement{
				{Type: entity.ElementKindText, Content: "This is a sentence with an image "},
				{Type: entity.ElementKindImage, Content: "![image](image.jpg)"},
				{Type: entity.ElementKindText, Content: " at the end."},
			},
		},
		{
			...
			expect: []entity.LineElement{
				{Type: entity.ElementKindImage, Content: "![image](image.jpg)"},
				{Type: entity.ElementKindText, Content: "[link](https://example.com)"},
			},
		},
		{
			...
			expect: []entity.LineElement{
				{Type: entity.ElementKindText, Content: "# Heading with an image "},
				{Type: entity.ElementKindImage, Content: "![image](image.jpg)"},
			},
		},
		{
			...
			expect: []entity.LineElement{
				{Type: entity.ElementKindText, Content: "- List item with an image "},
				{Type: entity.ElementKindImage, Content: "![image](image.jpg)"},
			},
		},
		{
			...
			expect: []entity.LineElement{
				{Type: entity.ElementKindText, Content: "> Blockquote with an image "},
				{Type: entity.ElementKindImage, Content: "![image](image.jpg)"},
			},
		},
		{
			...
			expect: []entity.LineElement{
				{Type: entity.ElementKindText, Content: "~~Strikethrough with an image "},
				{Type: entity.ElementKindImage, Content: "![image](image.jpg)"},
		...
		},
		{
			...
			expect: []entity.LineElement{
				{Type: entity.ElementKindText, Content: "H~2~O "},
				{Type: entity.ElementKindImage, Content: "![image](image.jpg)"},
			},
		},
		{
			...
			expect: []entity.LineElement{
				{Type: entity.ElementKindText, Content: "X^2^ "},
				{Type: entity.ElementKindImage, Content: "![image](image.jpg)"},
			},
		},
	}
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			got := parseLineImageElement([]entity.LineElement{{Type: entity.ElementKindText, Content: test.input}})
