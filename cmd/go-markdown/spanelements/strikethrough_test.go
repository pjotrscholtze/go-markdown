...
func TestParseLineStrikethroughElement(t *testing.T) {
	tests := []struct {
		...
		{name: "Single word strikethrough:", input: "~~Hello~~", expect: []entity.LineElement{
			{Type: entity.ElementKindStrikethrough, Content: "~~Hello~~"},
		}},
		{name: "Multiple words strikethrough:", input: "~~Hello World~~", expect: []entity.LineElement{
			{Type: entity.ElementKindStrikethrough, Content: "~~Hello World~~"},
		}},
		{name: "Strikethrough within a sentence:", input: "This is a ~~strikethrough~~ test.", expect: []entity.LineElement{
			{Type: entity.ElementKindText, Content: "This is a "},
			{Type: entity.ElementKindStrikethrough, Content: "~~strikethrough~~"},
			{Type: entity.ElementKindText, Content: " test."},
		}},
		...
		{name: "Strikethrough with numbers:", input: "~~1234567890~~", expect: []entity.LineElement{
			{Type: entity.ElementKindStrikethrough, Content: "~~1234567890~~"},
		}},
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			got := parseLineStrikethroughElement([]entity.LineElement{{Type: entity.ElementKindText, Content: test.input}})
